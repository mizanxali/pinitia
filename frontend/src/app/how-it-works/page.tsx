  ...
  const steps = [
    {
      ...
      title: "Browse Venues",
      description:
        "Explore curated Google Maps venues - restaurants, cafes, landmarks, and more. Each venue shows its current rating, review count, and active prediction markets.",
      color: "bg-primary",
    },
    {
      number: "02",
      title: "Pick a Market",
      description:
        "Each venue can have markets on two types of predictions: will the review count hit a target (Velocity), or will the rating reach a certain level (Rating)? Every market has a resolve date.",
      color: "bg-secondary",
    },
    {
      number: "03",
      ...
      description:
        "Think the target will be hit? Go LONG. Think it won't? Go SHORT. Place your bet with GAS tokens - the more your conviction, the bigger the position.",
      color: "bg-main",
    },
    {
      number: "04",
    ...
    <div>
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="border-2 border-border bg-card p-6 shadow-neo">
          <h3 className="font-heading text-lg font-extrabold">Market Types</h3>
          <ul className="mt-3 space-y-3 font-body text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Velocity</strong> - Will the venue gain a target number
                of new reviews by the resolve date?
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span
              ...
              <span>
                <strong>Rating</strong> - Will the venue&apos;s rating reach a
        ...
        <div className="border-2 border-border bg-card p-6 shadow-neo">
          ...
          <ul className="mt-3 space-y-2 font-body text-sm text-muted-foreground">
            ...
            <li>
              <strong className="text-foreground">Fee:</strong> 2% protocol fee
              on winnings
            </li>
            <li>
              <strong className="text-foreground">Oracle:</strong> Google Places
              API, posted on-chain hourly
            </li>
            <li>
